...
class Update
{
    ...
    public function __construct(
        $input_data,
        Telegram $telegram,
        callable $message_handler = null,
        callable $inline_query_handler = null,
        callable $chosen_inline_result_handler = null,
        callable $callback_query_handler = null,
        callable $shipping_query_handler = null,
        callable $pre_checkout_query_handler = null,
        callable $poll_handler = null,
        callable $poll_answer_handler = null,
        callable $chat_member_updated_handler = null,
        callable $chat_join_request_handler = null
    ) {
        $init_data = json_decode($input_data);
        ...
        if (is_object($init_data)) {
            ...
            if (property_exists($init_data, "message")) {
                ...
                if ($message_handler != null) {
                    call_user_func($message_handler, $this->message, $telegram);
                }
            }
            ...
            if (property_exists($init_data, "chosen_inline_result")) {
                ...
                if ($chosen_inline_result_handler != null) {
                    call_user_func(
            ...
            if (property_exists($init_data, "callback_query")) {
                ...
                if ($callback_query_handler != null) {
                    call_user_func(
            ...
            if (property_exists($init_data, "shipping_query")) {
                ...
                if ($shipping_query_handler != null) {
                    call_user_func(
            ...
            if (property_exists($init_data, "pre_checkout_query")) {
                ...
                if ($pre_checkout_query_handler != null) {
                    call_user_func(
            ...
            if (property_exists($init_data, "poll")) {
                ...
                if ($poll_handler != null) {
                    call_user_func($poll_handler, $this->poll, $telegram);
                }
            }
            ...
            if (property_exists($init_data, "my_chat_member")) {
                ...
                if ($chat_member_updated_handler != null) {
                    call_user_func(
            ...
            if (property_exists($init_data, "chat_join_request")) {
                ...
                if ($chat_join_request_handler != null) {
                    call_user_func(
...
class Message
{
    ...
    public function __construct($init_data)
    {
        ...
        if (property_exists($init_data, "forward_from")) {
            $this->forward_from = new User($init_data->forward_from);
        }

        if (property_exists($init_data, "forward_from_chat")) {
            $this->forward_from_chat = new Chat($init_data->forward_from_chat);
        }
        ...
        if (property_exists($init_data, "user_shared")) {
            $this->user_shared = new UserShared($init_data->user_shared);
        }
